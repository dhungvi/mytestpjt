...
my $base_dir = "/shared/karrojegrp/EAST_Test";
...
#my $cap3ConsensusFile = "estFile.fa.cap.contigs";
#my $cap3SingletonFile = "estFile.fa.cap.singlets";
	...
	system("java eSTAssembly.ESTAssembly eSTAssembly/$configFile $estFile $mstFile $eastConsensusFile $eastSingletonFile $eastNum > $eastDebugFile");
	my $time2 = time();
	my @time;
	...
	#$configFile = "analysis.$id.properties";
	#system("cp analysis.properties $configFile");
	$configFile = "analysis.properties";
